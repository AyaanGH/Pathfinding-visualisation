       ...
       # print("Dequed Sequence: ", dequeued)
        ...
        for actions in ["N","S","E","W"]:
           ...
           # print(dequeued[-1])
            ...
            check_actions = valid(actions, table, last_coord_of_dequed,size_x,size_y)
...
if __name__ == "__main__":
    while True:
        ...
        weighted_search_result = weighted_search(weighted_search_result_table, coords, start_x, start_y, end_x, end_y, node_map, x, y)
        ...
        print_table( path_table(weighted_search_result,weighted_search_result_table))
        ...
        bfs_result = bfs(coords,bfs_table,start_x,start_y,end_x,end_y,x,y)
